class Game{
    ...
    start(){
        ...
        this.addSprites(obsG1, obsImg1, obstacles1.length, 0.2, obstacles1)
        this.addSprites(obsG2, obsImg2, obstacles2.length, 0.2, obstacles2)
    ...
    gameOver(){
        swal({
            title:"que pena ",
            text:"a gasolina ta custando um rim e meio :(",
            imageUrl:"https://tse4.mm.bing.net/th?id=OIP.qCKjPDzCRuzR2pLXijoAyQHaEe&pid=Api&P=0",
            imageSize:"200x100",
            confirmeButtonText:"eu ganhei a loteria"
        });
       }
        ...
        mostrarRank() {
            swal({
              ...
              text: "deixaram um bando de coisa cara no chao",
              imageUrl:"https://tse3.explicit.bing.net/th?id=OIP.hOrfZq98E7lbJo2VcyBsRQAAAA&pid=Api&P=0",
              imageSize: "100x100",
